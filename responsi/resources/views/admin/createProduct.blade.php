        ...
        <div class="container-fluid card-body">
          <form action="{{ route('storeProduct') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-3">
              ...
              <input name="tipe" type="text" class="form-control @error ('tipe') is-invalid @enderror">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input name="ukuran" type="number" class="form-control @error ('ukuran') is-invalid @enderror">
            </div>
            <div class="mb-3">
